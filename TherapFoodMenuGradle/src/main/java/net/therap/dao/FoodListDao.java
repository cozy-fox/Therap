...
public class FoodListDao {
    ...
    public List<Food> getAvailableFoodsListForDate(String mealType, String dateToFind) {
        ...
        if (mealType!=null)
            ...
            queryString = "SELECT * FROM food_list WHERE id NOT IN ( SELECT f_id FROM meal_list_tmp WHERE AND day_added='"+dateToFind+"')";
    ...
    public List<Food> getFoodsListForDate(String mealType, String dateToFind) {
        ...
        if (mealType!=null)
            ...
            queryString = "SELECT * FROM food_list WHERE id IN ( SELECT f_id FROM meal_list_tmp WHERE AND day_added='"+dateToFind+"')";
    ...
    public List<Food> getAllFoodList() {
        String queryString = "SELECT * FROM food_list";
    ...
    public void addNewFoodToFoodList(String foodName) {
        new DatabaseTemplate().executeInsertQuery("INSERT INTO food_list(id,f_name) VALUES(?,?)", 0, foodName);
    }
}
