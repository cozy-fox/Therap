...
public class DatabaseTemplate {
    ...
    private net.therap.util.DatabaseConnection databaseConnection = null;
//    static Logger log = Logger.getLogger(DatabaseTemplate.class);

    public DatabaseTemplate () {
        databaseConnection = new net.therap.util.DatabaseConnection();
    }
    ...
    public <E> List<E> queryForObject(String query, net.therap.util.ObjectRowMapper<E> objectRowMapper) {
//        log.info(query);
